...
def stat_dict_return(dict_result, filename_save, num_stock_sel, low_bound_pa, save_path=''):
    ...
    if len(list_return)>0:
        ...
        print('mean of return with selecting {:2d} stock: None'.format(num_stock_sel))
        print('95% confidience interval of return with selecting {:2d} stocks: None'.format(num_stock_sel))
        print('The ratio of return>{:2f}: None'.format(low_bound_pa))
